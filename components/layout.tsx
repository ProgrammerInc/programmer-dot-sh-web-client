...
const Layout = ({ title, description, url, ogImage, children }: ILayoutProps) => {
  ...
  return (
    <>
      <Head>
        ...
        <script async src="https://www.googletagmanager.com/gtag/js?id=UA-177858408-2"></script>
        <script
